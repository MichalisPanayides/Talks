...
\begin{frame}
    ...
    \vspace{1cm}
    \includegraphics[scale=0.2]{Bin/game_avatars/arrows.png}
    \hspace{2cm}
...
\begin{frame}
    \frametitle{4. Game theoretic model - Imperfect information game}
    \centering
    ...
    \begin{figure}[ht]
        ...
        \begin{tikzpicture}[-, node distance = 3cm, scale=0.8]
            ...
            \node[anchor=north](D) at (7.9, 0){\scriptsize{\(A\)}};
