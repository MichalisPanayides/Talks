...
\begin{frame}
    ...
    \begin{minipage}{.4\textwidth}
        ...
        \vspace{0.3cm}
        \begin{figure}
            \includegraphics[width=0.9\textwidth, height=0.4\textheight]{pictures/main.jpg}
        \end{figure}
    \end{minipage}
    \begin{minipage}{.50\textwidth}
        ...
        \begin{figure}
            \begin{tikzpicture}[>=stealth, scale=0.6],
                ...
                % Animations
                \node[draw=none] at (7.75,0.8) {\Strichmaxerl[1]};
                \node[draw=none] at (7.75,0.2) {\Strichmaxerl[1]};
    ...
    \begin{minipage}{.4\textwidth}
        ...
        \begin{figure}
            \vspace*{-80pt}
            \hspace*{-140pt}
            \includegraphics[width=.4\textwidth]{pictures/uni_logo.png}
        \end{figure}
    \end{minipage}
    \begin{minipage}{.49\textwidth}
        \centering
        \vspace*{-5pt}
        \includegraphics[width=1\textwidth, height=.5\textheight]{game_plot/main.pdf}
    \end{minipage}
