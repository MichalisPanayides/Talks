...
\begin{frame}
    ...
    \begin{itemize}
        \item Harper, P., Knight, V. and Panayides, M., 2020. \textit{On a queueing model with two waiting rooms}. 
        \item Harper, P., Knight, V. and Panayides, M., 2020. \textit{A game theoretic model of the ED-EMS interface.}
    \end{itemize}
