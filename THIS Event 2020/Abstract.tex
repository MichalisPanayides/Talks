...
% Although, such methods are powerful, they sometimes lack the possible insight that one may get by considering more qualitative approaches. The \textit{precursor} of such approaches is considered by many to be ethnography. 

% Two additional concepts of 
