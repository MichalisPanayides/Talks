    ...
    \begin{minipage}{.35\textwidth}
        \begin{figure}
            \begin{tikzpicture}
                ...
                \draw[-, ultra thick] (0.5, 2) -- ++(-1, 0) node[left] {\(\lambda_2\)};
                
                % p_A line
                \path[ultra thick] (0.49, 2) edge [bend right=30] (1.2, 2.5);
                \path[ultra thick] (1.2, 2.5) edge [bend left=30] (1.7, 2.7);
                \draw[->, ultra thick] (1.7, 2.7) -- ++(0.6, 0.);
                
                % p_B
                \path[ultra thick] (0.49, 2) edge [bend left=30] (1.2, 0.9);
                \path[ultra thick] (1.2, 0.91) edge [bend right=30] (1.7, 0.47);
                \draw[->, ultra thick] (1.7, 0.47) -- ++(0.6, 0.);
